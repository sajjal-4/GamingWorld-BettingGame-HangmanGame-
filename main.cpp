...
game:  
cout << "\n\nHey there "<< playerName<<"! Enter the starting balance to play game : 
Rs ";   
cin >> balance;   
do  
{   
...
cout << "\n○ Your betting balance can't be more than the current 
...
cout << "\t○ If you fail to guess then you will be simply hanged and be named the 
hangman!\n";  
cout << "\t○ Remember the time limit for this game is 120 sec!\n\n";  
const int Total_Chances = 7;  // maximum number of incorrect guesses allowed    // 
